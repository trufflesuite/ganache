...
Receipt.prototype.toJSON = function() {
  ...
  return {
    ...
    transactionIndex: to.hexWithoutLeadingZeroes(this.transactionIndex),
    blockHash: to.hex(this.block.hash()),
    blockNumber: to.hexWithoutLeadingZeroes(this.block.header.number),
    gasUsed: to.hexWithoutLeadingZeroes(this.gasUsed),
    cumulativeGasUsed: to.hexWithoutLeadingZeroes(this.block.header.gasUsed),
