...
function Provider(options) {
  ...
  var gethApiDouble = new GethApiDouble(Object.assign({}, this.options, { _provider: self }));
...
Provider.prototype.send = function(payload, callback) {
  ...
  var intermediary = function(err, result) {
    ...
    // mutating things
    var response = _.cloneDeep(result);

    response = self.reportErrorInResponse(payload, err, response);
