  ...
  vm.runBlock(
    ...
    async function(vmerr, results) {
      ...
      for (var v = 0; v < results.receipts.length; v++) {
        ...
        // if (steps.ops.length) {
        //   let ii = 0;
        //   while (existsSync(`/home/cashlion/Desktop/gaslogs/${ii}`)) {
        //     ii++;
        //   }
        //   writeFileSync(
        //     `/home/cashlion/Desktop/gaslogs/${ii - 1}/ACTUAL.txt`,
        //     steps.ops
        //       .map(
        //         (val) =>
        //           // eslint-disable-next-line max-len
        //           `${val.depth}  ${val.opcode.name}: ${
        //             val.opcode.fee
        //           } ${val.gasLeft.toNumber()} ${val.gasLeft.toNumber() - val.opcode.fee}`
        //       )
        //       .join("\n")
        //   );
        // }
