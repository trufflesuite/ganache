...
describe("api", () => {
  describe("personal", () => {
    ...
    async function testLockedAccountWithPassphraseViaEth_SendTransaction(provider: EthereumProvider, newAccount: string, passphrase: string) {
      const transaction = {
        from: newAccount,
        to: newAccount,
        gasLimit: 21000,
    ...
    async function testLockedAccountWithPassphraseViaPersonal_SendTransaction(provider: EthereumProvider, newAccount: string, passphrase: string){
      const transaction = {
        from: newAccount,
        to: newAccount,
        gasLimit: 21000,
    ...
    describe("personal_importRawKey", () => {
      ...
      it("should return the known account address", async () => {
        ...
        assert.strictEqual(newAccount, "0x14791697260e4c9a71f18484c9f997b308e59325", "Raw account not imported correctly");
      });
