// import _StateManager from "@ethereumjs/vm";
// import {
//   Account,
//   BN,
//   bufferToHex,
...
// export class ForkStateManager extends _StateManager {
//   private _state: any = new Map();
//   private _initialStateRoot: string = "0x1234";
//   private _stateRoot: string = this._initialStateRoot;
//   private _stateRootToState: Map<string, any> = new Map();
...
//   constructor(
//     private readonly _jsonRpcClient: any,
...
//     return (fsm as any) as _StateManager;
//   }
...
//     return new Account({ nonce: new BN(nonce), balance, codeHash });
//   }
