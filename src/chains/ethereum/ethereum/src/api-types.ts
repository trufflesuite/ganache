...
export namespace Ethereum {
  ...
  > = T extends "internal"
    ...
    : Externalize<TraceTransactionResult<"internal">>;
  export type StorageRangeAtResult<
    T extends "external" | "internal" = "external"
  > = T extends "internal"
    ? UtilTypes.StorageRangeAtResult
    : Externalize<StorageRangeAtResult<"internal">>;
  ...
  export type SignedTransaction<
    T extends "external" | "internal" = "external"
  > = T extends "internal"
    ? TransactionTypes.TypedTransactionJSON
    : Externalize<SignedTransaction<"internal">>;
  export type TransactionReceipt<
    T extends "external" | "internal" = "external"
  > = T extends "internal"
    ? TransactionTypes.TransactionReceipt
    : Externalize<TransactionReceipt<"internal">>;
  ...
  > = T extends "internal"
    ? {
        ...
        transactions: IncludeTransactions extends true
          ? (SignedTransaction<T> | PooledTransaction<T>)[]
          : Data[];
        uncles: Data[];
      } & BlockHeader
    : {
