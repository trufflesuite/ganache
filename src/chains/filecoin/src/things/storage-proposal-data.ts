...
class StorageProposalData extends SerializableObject<StorageProposalDataConfig> implements DeserializedObject<StorageProposalDataConfig> {
...
type SerializedStorageProposalData = SerializedObject<StorageProposalDataConfig>;
