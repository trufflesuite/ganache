...
export type OptionRawType<C extends Base.Config, N extends OptionName<C> = OptionName<C>> = void extends Option<
  C,
  N
>["rawType"]
  ? Option<C, N>["type"]
...
export type OptionHasDefault<C extends Base.Config, N extends OptionName<C> = OptionName<C>> = Option<
  C,
  N
>["hasDefault"];
