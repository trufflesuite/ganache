...
describe("Solidity Strings", function() {
  describe("modifying public strings", function() {
    ...
    it("replacing a long string with a short string", async function() {
      ...
      // Set and confirm (also within the EVM) a long string setting to a public variable
      ...
      // Set and confirm (also within the EVM) a short string setting to a public variable
      const text2 = "123";
