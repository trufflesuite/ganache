...
- Use Node.js v12.16.0.
  - Why v12.16.0? Because this is the first LTS release of Node.js v12 and is the earliest version Ganache supports.
  - recommendation: use [nvm](https://github.com/nvm-sh/nvm) on Linux and macOS, and [nvm-windows](https://github.com/coreybutler/nvm-windows) on
    ...
    - On Linux and macOS, if you have `nvm` installed, just run `nvm use` to switch to Node.js v12.16.0.
...
- Use Node.js v12.16.0 for most local development.
