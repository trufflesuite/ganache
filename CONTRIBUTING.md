...
- Use Node.js v12.19.1.
  - Why v12.19.1? Because this is the first LTS release of Node.js v12 and is the earliest version Ganache supports.
  - recommendation: use [nvm](https://github.com/nvm-sh/nvm) on Linux and macOS, and [nvm-windows](https://github.com/coreybutler/nvm-windows) on
    ...
    - On Linux and macOS, if you have `nvm` installed, just run `nvm use` to switch to Node.js v12.19.1.
...
- Use Node.js v12.19.1 for most local development.
