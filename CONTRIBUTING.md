...
- Use Node.js v10.18.0.
  - Why v10.18.0? Because this is the first version lerna supports.
  - recommendation: use [nvm](https://github.com/nvm-sh/nvm) on Linux and macOS, and [nvm-windows](https://github.com/coreybutler/nvm-windows) on
    ...
    - On Linux and macOS, if you have `nvm` installed, just run `nvm use` to switch to Node.js v10.18.0.
...
- Use Node.js v10.18.0 for most local development.
